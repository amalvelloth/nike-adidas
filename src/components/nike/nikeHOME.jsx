    ...
    <>
      ...
      <nav className="bg-white w-full fixed shadow-lg z-20">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          ...
          <div>
            <a href="">
              <svg aria-hidden="true" className="swoosh-svg" focusable="false" viewBox="3 8 18 7" role="img" width="44px" height="44px" fill="none">
      ...
      <section>
        <div className="relative bg-white bg-cover h-screen overflow-hidden">
          ...
          <div className="absolute inset-10 sm:inset-1 flex flex-row sm:flex-col md:flex-col justify-between items-start md:items-center text-center">
            ...
            <div className="flex flex-col sm:mt-12 justify-start items-start" ref={ref}>
              
              <motion.h1
                initial="hidden"
                animate={controls}
                variants={animationVariants}
                className="text-5xl hover:text-gray-300 transition ease-in-out cursor-pointer font-Lato"
              >MERCURIAL</motion.h1>
              ...
              <motion.div className="relative flex justify-center items-center shadow-md rounded-t-4xl rounded-b-md my-10 px-4 py-10 w-96 h-80 sm:w-80 sm:h-80 md:w-96 md:h-80 lg:w-96 lg:h-80 xl:w-96 xl:h-80 bg-black">
                <h1 className="absolute text-white text-2xl font-Monsterrat font-semibold bottom-4"> Gear up for Greatness</h1>
              </motion.div>
            </div>
